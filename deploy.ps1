...
# Déploiement Phase 1: Per-Tenant Encryption + IPv4 Fix

Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "🚀 DÉPLOIEMENT PHASE 1" -ForegroundColor Green
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host ""

$server = "root@135.125.235.103"
...
Write-Host "   ssh root@135.125.235.103" -ForegroundColor Gray
Write-Host ""
...
Write-Host "   - FORCE_IPV4=\${FORCE_IPV4}" -ForegroundColor Gray
Write-Host ""
Write-Host "4. Rebuild et redémarre:" -ForegroundColor White
...
Write-Host ""
Write-Host "=========================================" -ForegroundColor Cyan
Write-Host "📋 Voir DEPLOY_NOW.md pour plus de détails" -ForegroundColor White
Write-Host "=========================================" -ForegroundColor Cyan